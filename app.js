...
async function carrierDashboard(){
 ...
 $("#carrierForm").onsubmit=async e=>{
   ...
   try{
     ...
     const vehicle=await uploadCarrierPhoto(d.vehicle_photo,"vehicle-1",u.id);
     const vehicle2=await uploadCarrierPhoto(d.vehicle_photo_2,"vehicle-2",u.id);
